...
import { Ellipsis, Plus, Shrub } from '@lucide/vue';

const openPropertyDetails = () => {
  navigateTo('/admin/properties/1')
}
</script>
  ...
  <div>
    <section>
      <div class="flex justify-between items-center">
        <h3 class="text-2xl font-semibold">All Properties</h3>
        <Button>
          <Plus />
      ...
      <div class="p-4 mt-4 border border-zinc-200 rounded-xl flex flex-col gap-2">
        <div class="flex justify-between items-center border-b border-zinc-200 pb-2">
          ...
          <div class="flex gap-2 items-center">
            <Button @click="openPropertyDetails" variant="outline">View Details</Button>
            <Button size="icon">
              <Ellipsis />
            </Button>
          </div>
